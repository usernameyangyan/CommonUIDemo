...
import com.common.ui.base.set.LinkedMultiValueMap
...
abstract class ICommonActivity : AppCompatActivity() {
    ...
    private var bindingActivityLayout:View?=null
            ...
            if (isShowCustomActionBar) {
                if (customRes != 0) {
                    customBar = LayoutInflater.from(this)
                        .inflate(customRes,parent , false)
                    parent.addView(customBar)
                } else {
