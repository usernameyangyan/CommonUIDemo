...
class SharePreference private constructor() {
    companion object {
        val instance: SharePreference by lazy { SharePreference() }
    }
    ...
    init {
        ...
        sharedPreferences= LocalDataConfig.instance!!.getContext().getSharedPreferences(
            LocalDataConfig.instance!!.getSharePreferenceName(), Context.MODE_PRIVATE)
    }
