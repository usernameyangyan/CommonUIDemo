...
class SqlHelper {
    ...
    companion object {
        ...
        const val PREFS_TABLE_VERSION_KEY = "collection_library_prefs_versioins"
        /**
        ...
        fun getTableVersion(): Int {
            ...
            return LocalDataConfig.instance!!.getSqliteDBVersion()
        }
        ...
        fun getColumType(clazz: String): String {
            var type = ""
            when (clazz) {
                "java.lang.Integer", "int", "java.lang.Short", "short" -> {
                    type = "INTEGER"
                }
